...
class Sumador : public sc_module
{
	public:
		...
		SC_CTOR(Sumador)
		{
			...
			Gate_And_1->a_In(a_In_Sumador);
			Gate_And_1->b_In(b_In_Sumador);
			Gate_And_1->c_Out(Wire_2);

			Gate_And_2->a_In(Wire_1);
			Gate_And_2->b_In(c_In_Sumador);
			Gate_And_2->c_Out(Wire_3);
